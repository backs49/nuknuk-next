...
const ContentSecurityPolicy = [
  ...
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://t1.kakaocdn.net https://*.tosspayments.com https://developers.kakao.com https://sharer.kakao.com",
  ...
  "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.tosspayments.com https://developers.kakao.com https://sharer.kakao.com",
  // Toss 결제위젯 iframe, Google Maps 임베드, Kakao 공유 팝업
  "frame-src 'self' https://*.tosspayments.com https://www.google.com https://sharer.kakao.com",
  "object-src 'none'",
  "base-uri 'self'",
  "form-action 'self'",
