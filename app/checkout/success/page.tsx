...
function SuccessContent() {
  ...
  return (
    <div className="bg-white rounded-3xl p-8 max-w-md w-full mx-auto text-center shadow-lg border border-sage-100">
      ...
      <h2 className="text-2xl font-display font-bold text-charcoal-400 mb-3">예약 및 결제 완료</h2>
      <div className="bg-cream-100 rounded-xl p-4 mb-8 text-left text-sm text-charcoal-300">
        <p className="mb-1"><span className="font-semibold w-20 inline-block">결제 금액:</span> {Number(amount).toLocaleString()}원</p>
        <p className="truncate"><span className="font-semibold w-20 inline-block">주문 번호:</span> {orderId}</p>
        <p className="mt-3 text-sage-500 font-semibold text-center border-t border-warm-100 pt-3">
          예약이 완료되었습니다! 3초 후 메인으로 돌아갑니다.
        </p>
      </div>
